  ...
  return (
    <div ref={popupRef} className={`cart ${opened ? "open" : "close"} `}>
        ...
        <div className="container-sm container__cart">
          {item?.length > 0 ? (
            item.map((item, id) => (
              <div
                key={id}
                className="cart__block flex-wrap d-flex align-items-end flex-column"
              >
                <div className="w-100 align-items-center d-flex justify-content-between">
                  <div className="cart__item d-flex align-items-center w-100">
                    <img className="cart--image" src={item.image} alt="cart" />
                  ...
                  <div className="buttons__controller__first d-flex align-items-end flex-column">
                    <div className="d-flex align-items-center cart--controllers mb-2">
                      <button
                        className="cart--controller cart--remove"
                      ...
                      <div className="cart--num">{item.quantity}</div>
                      <button
                        className="cart--controller cart--add"
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <path
                            d="M17.5 11.2422L17.5 25.2422M10.5 18.2422L24.5 18.2422"
                            stroke="#2A2B40"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
                    ...
                    <div className="d-flex cart__buttons--controller"></div>
                  </div>
                </div>
                ...
                <div className="d-flex buttons__controller">
                  ...
                  <button
                    ...
                    className="accent__delete accent__btn accent__btn--dark"
                  >
                    Удалить
                  </button>
                </div>
      ...
      <div className="cart__buy">
        <button
          onClick={handleOrderOfProduct}
          disabled={!item.length ?? true}
          className={`accent__btn accent__btn--dark accent--active w-50 ${
            !item.length ? "accent__btn--disable" : ""
          }`}
        >
          Заказать
        </button>

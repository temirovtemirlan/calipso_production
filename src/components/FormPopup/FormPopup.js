...
const FormPopup = ({
  ...
  console.log("from formPopup ", item);
  ...
  return (
    <>
      <div className="form__order">
        <div
          ref={popupRef}
          className={`form__popup ${popup ? "form__show" : "form__hide"}`}
        >
            ...
            <div className="form__block d-flex">
              <div className="form__list d-flex flex-column">
                <h2 className="form__title">
                  {t("carts.order-1")} {quantities} {t("carts.order-2")}
                </h2>
                ...
                <div className="form__scroll">
                  {item.map((item, id) => (
                    <div
                      key={id}
                      className="form__cart cart__block flex-wrap d-flex align-items-end flex-column"
                    >
                ...
                <div
                  className="form__price-total d-flex justify-content-lg-end align-items-center"
                  style={{ marginRight: "50px" }}
                >
                  <h2 className="form__title form__price">
                    {result && (
                      <>
                        {t("carts.price")}: {result}
                        "сом"
                      </>
                    )}
                  </h2>
              ...
              <div className="form__form">
                ...
                <form
                  ...
                  className="form__popup-form d-flex flex-column"
                  action="POST"
                >
                  <input
  ...
  return (
    <>
      <div className={`message__block ${messageState ? "message__show" : ""}`}>
        ...
        <p className="message__text">{descr}</p>
      </div>
    </>
  );
};

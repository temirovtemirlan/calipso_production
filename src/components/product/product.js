...
function Product() {
  ...
  const descriptions = [
    // "Зеленый чай Calipso - это идеальный напиток для тех, кто ценит здоровый образ жизни и хочет наслаждаться естественным вкусом премиум-чая. Добытая с глубины 178 метров, наша вода обеспечивает наилучший баланс минералов для превращения высококачественных зеленых чайных листьев в освежающий напиток. Ваша чашка чая никогда не была такой приятной.",

    // "Газированная вода Calipso - это настоящее удовольствие, которое оживляет и освежает в течение всего дня. Используя наш источник воды с глубины 178 метров, мы создаем воду с нежным и естественным вкусом, усиленную тонкими пузырьками газа. Это идеальное средство для утоления жажды или просто для любителей более динамичных напитков.",

    // "Негазированная вода Calipso представляет собой воплощение чистоты и свежести. С глубины 178 метров мы добываем самую чистую, балансированную по минералам воду, которую затем бережно бутилируем, сохраняя все ее природные свойства. Это идеальный вариант для тех, кто предпочитает простую, но качественную воду.",

    // "Наша бутилированная вода в объеме 18,9 литров – это универсальное решение для больших семей, офисов или мероприятий. Это та же великолепная вода, добытая с глубины 178 метров, но в удобном большом объеме. С ней у вас всегда будет достаточно чистой воды для любых потребностей."
    t("products.product-1.descr"),
    t("products.product-2.descr"),
    t("products.product-3.descr"),
    t("products.product-4.descr")
  ];

  const title = [
    t("products.product-1.title"),
    t("products.product-2.title"),
    t("products.product-3.title"),
    t("products.product-4.title"),
  ];
  ...
  return (
    ...
    <div className="overflow-x product-slider product__container">
          <div className="product__inner">
              <h2 className="title product__title">{t('products-title')}</h2>
